...
--chip-h:        39px;   /* внешняя высота чипа из макета (мобайл — 37) */
--chip-pad-x:    16px;   /* его паддинг по горизонтали (мобайл — 14) */
--badge-h:       29px;   /* внешняя высота бейджа из макета (мобайл — 24) */
--badge-pad-x:   12px;   /* его паддинг по горизонтали (мобайл — 10) */
