...
- **13–19 — редизайн листинга проектов** (`/projects`: hero+секции-витрины+теги-фильтры; `/projects/:cat` — страница категории с табами и инфинити-скроллом); источник правды — `docs/projects-redesign.md`, дизайн — `front/1111.pen` (смотреть ТОЛЬКО через Pencil MCP, файл зашифрован).
